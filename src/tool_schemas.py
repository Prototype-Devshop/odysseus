...
FUNCTION_TOOL_SCHEMAS = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "List configured and enabled media-generation models (image models) with their capabilities and which one is the default. Call this to discover available image models BEFORE generate_image — never guess model names like 'Stable Diffusion' or 'FLUX'.",
            "parameters": {
                "type": "object",
                "properties": {
